...
HX_STACK_ARG(height,"height")
{
	...
	Void run(::String message){
		HX_STACK_FRAME("*","_Function_1_2",0x5200ed38,"*._Function_1_2","openfl/_v2/display/Stage.hx",140,0xd25d2a60)
...
{
		HX_STACK_FRAME("openfl._v2.display.Stage","dummyTrace",0xf097e20a,"openfl._v2.display.Stage.dummyTrace","openfl/_v2/display/Stage.hx",354,0xd25d2a60)
		HX_STACK_THIS(this)
		HX_STACK_LINE(354)
		::haxe::Log_obj::trace(HX_CSTRING(""),hx::SourceInfo(HX_CSTRING("Stage.hx"),354,HX_CSTRING("openfl._v2.display.Stage"),HX_CSTRING("dummyTrace")));
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl._v2.display.Stage","__setActive",0xb282307b,"openfl._v2.display.Stage.__setActive","openfl/_v2/display/Stage.hx",1074,0xd25d2a60)
		HX_STACK_THIS(this)
		...
		if (((this->active != value))){
			...
			if ((value)){
				...
				if (((  (((focus->__get((int)0).StaticCast< ::openfl::_v2::display::InteractiveObject >() != null()))) ? bool(focus->__get((int)0).StaticCast< ::openfl::_v2::display::InteractiveObject >()->get_needsSoftKeyboard()) : bool(false) ))){
					...
					Void run(){
						HX_STACK_FRAME("*","_Function_4_1",0x520333fa,"*._Function_4_1","openfl/_v2/display/Stage.hx",1100,0xd25d2a60)
						{
							HX_STACK_LINE(1100)
