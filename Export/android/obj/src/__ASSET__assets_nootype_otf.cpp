...
{
HX_STACK_FRAME("__ASSET__assets_nootype_otf","new",0xf0382830,"__ASSET__assets_nootype_otf.new","DefaultAssetLibrary.hx",827,0x0fc48912)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(827)
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(__ASSET__assets_nootype_otf_obj::__mClass,"__mClass");
};
