...
::__ASSET__assets_nootype_otf_obj::__register();
::openfl::_v2::text::Font_obj::__register();
::DefaultAssetLibrary_obj::__register();
::openfl::_v2::AssetLibrary_obj::__register();
::DefBTN_obj::__register();
::Date_obj::__register();
::CharOBJOperator_obj::__register();
::CharOBJ_obj::__register();
::CanvasOBJ_obj::__register();
