...
{
HX_STACK_FRAME("CanvasOBJ","new",0xbf00ca51,"CanvasOBJ.new","CanvasOBJ.hx",11,0x0698aa3f)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(21)
...
{
		HX_STACK_FRAME("CanvasOBJ","nyGubbe",0x7d2acf5d,"CanvasOBJ.nyGubbe","CanvasOBJ.hx",38,0x0698aa3f)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(39)
