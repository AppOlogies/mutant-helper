...
class HXCPP_CLASS_ATTRIBUTES  NameInput_obj : public ::openfl::_v2::display::Sprite_obj{
	public:
		...
		NameInput_obj();
		Void __construct(::String namestring);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< NameInput_obj > __new(::String namestring);
		...
		::openfl::_v2::text::TextField nameField2;
		::openfl::_v2::text::TextFormat textFormat;
		virtual Void added( ::openfl::_v2::events::Event e);
		Dynamic added_dyn();

		virtual Void textclick( ::openfl::_v2::events::MouseEvent e);
		Dynamic textclick_dyn();
