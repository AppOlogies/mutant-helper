...
class HXCPP_CLASS_ATTRIBUTES  __ASSET__assets_nootype_otf_obj : public ::openfl::_v2::text::Font_obj{
	public:
	...
	public:
		...
		::String __ToString() const { return HX_CSTRING("__ASSET__assets_nootype_otf"); }
