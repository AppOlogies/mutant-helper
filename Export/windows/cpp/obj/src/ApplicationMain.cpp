...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(22)
		::openfl::_v2::Lib_obj::setPackage(HX_CSTRING("Company Name"),HX_CSTRING("Mutant"),HX_CSTRING("com.sample.project"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(35)
		::openfl::_v2::Lib_obj::create( Dynamic(new _Function_1_1()),(int)660,(int)980,(int)60,(int)0,(int((int((int((int((int((int((int((int((int((int(::openfl::_v2::Lib_obj::HARDWARE) | int(::openfl::_v2::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::openfl::_v2::Lib_obj::RESIZABLE))) | int((int)0))) | int(::openfl::_v2::Lib_obj::VSYNC))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("Mutant"),null(),null());
	}
return null();
}
