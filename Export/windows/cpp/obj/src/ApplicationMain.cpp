...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(98)
		int tmp1 = (int)16777215;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(103)
		int tmp2 = (int)30;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(106)
		int tmp3 = (int)960;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(114)
		int tmp4 = (int)640;		HX_STACK_VAR(tmp4,"tmp4");
		struct _Function_1_1{
			inline static Dynamic Block( int &tmp,int &tmp4,int &tmp2,int &tmp3,int &tmp1){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","ApplicationMain.hx",95,0x0780ded5)
				{
					...
					__result->Add(HX_HCSTRING("file","\x7c","\xce","\xbb","\x43") , HX_HCSTRING("Mutant","\x7b","\x62","\x53","\x74"),false);
					...
					__result->Add(HX_HCSTRING("title","\x98","\x15","\x3b","\x10") , HX_HCSTRING("Mutant","\x7b","\x62","\x53","\x74"),false);
