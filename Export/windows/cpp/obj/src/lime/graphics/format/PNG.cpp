...
::lime::utils::ByteArray PNG_obj::encode( ::lime::graphics::Image image){
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(71)
		Dynamic tmp3 = ::lime::graphics::format::PNG_obj::lime_image_encode(tmp2,(int)0,(int)0);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(71)
...
struct _Function_0_1{
	inline static Dynamic Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","lime/graphics/format/PNG.hx",138,0x0cfd2463)
		{
			HX_STACK_LINE(138)
