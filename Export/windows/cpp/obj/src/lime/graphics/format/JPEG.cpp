...
::lime::utils::ByteArray JPEG_obj::encode( ::lime::graphics::Image image,int quality){
	...
	HX_STACK_LINE(62)
	Dynamic tmp2 = ::lime::graphics::format::JPEG_obj::lime_image_encode(tmp,(int)1,tmp1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(62)
...
struct _Function_0_1{
	inline static Dynamic Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","lime/graphics/format/JPEG.hx",81,0x0d45bec8)
		{
			HX_STACK_LINE(81)
...
struct _Function_0_2{
	inline static Dynamic Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","lime/graphics/format/JPEG.hx",82,0x0d45bec8)
		{
			HX_STACK_LINE(82)
