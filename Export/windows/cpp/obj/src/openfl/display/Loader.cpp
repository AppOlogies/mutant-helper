...
;
		...
		Void run(Dynamic _){
			...
			{
				HX_STACK_LINE(432)
				::String tmp11 = request->url;		HX_STACK_VAR(tmp11,"tmp11");
				...
				Void run(::openfl::display::BitmapData bitmapData){
					HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","openfl/display/Loader.hx",432,0x7a569d9f)
					HX_STACK_ARG(bitmapData,"bitmapData")
					{
						HX_STACK_LINE(432)
						::openfl::display::BitmapData tmp12 = bitmapData;		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(432)
						worker->__Field(HX_HCSTRING("sendComplete","\x21","\xd2","\x84","\xc0"), hx::paccDynamic )(tmp12);
					}
					return null();
				}
				HX_END_LOCAL_FUNC1((void))
				...
				Void run(){
					HX_STACK_FRAME("*","_Function_2_2",0x5201af79,"*._Function_2_2","openfl/display/Loader.hx",432,0x7a569d9f)
					{
						HX_STACK_LINE(432)
						::String tmp12 = ::openfl::events::IOErrorEvent_obj::IO_ERROR;		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(432)
						worker->__Field(HX_HCSTRING("sendError","\x60","\x89","\x99","\x33"), hx::paccDynamic )(tmp12);
					}
					return null();
				}
				...
				HX_STACK_LINE(432)
				::openfl::display::BitmapData_obj::fromFile(tmp11, Dynamic(new _Function_2_1(worker)), Dynamic(new _Function_2_2(worker)));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))
...
{
		HX_STACK_FRAME("openfl.display.Loader","loadBytes",0x5dd804b4,"openfl.display.Loader.loadBytes","openfl/display/Loader.hx",529,0x7a569d9f)
		HX_STACK_THIS(this)
		...
		int __ArgCount() const { return 1; }
		Void run(Dynamic _){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/display/Loader.hx",533,0x7a569d9f)
			HX_STACK_ARG(_,"_")
			{
				HX_STACK_LINE(535)
				...
				int __ArgCount() const { return 1; }
				Void run(::openfl::display::BitmapData bitmapData){
					HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","openfl/display/Loader.hx",535,0x7a569d9f)
					HX_STACK_ARG(bitmapData,"bitmapData")
					{
						HX_STACK_LINE(535)
...
{
		HX_STACK_FRAME("openfl.display.Loader","unload",0x847d3950,"openfl.display.Loader.unload","openfl/display/Loader.hx",568,0x7a569d9f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(570)
...
bool gc = __o_gc.Default(true);
	HX_STACK_FRAME("openfl.display.Loader","unloadAndStop",0x25cb8709,"openfl.display.Loader.unloadAndStop","openfl/display/Loader.hx",626,0x7a569d9f)
	HX_STACK_THIS(this)
	HX_STACK_ARG(gc,"gc")
{
		HX_STACK_LINE(626)
...
{
		HX_STACK_FRAME("openfl.display.Loader","BitmapData_onLoad",0x9c5aef1a,"openfl.display.Loader.BitmapData_onLoad","openfl/display/Loader.hx",638,0x7a569d9f)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bitmapData,"bitmapData")
		HX_STACK_LINE(640)
...
{
		HX_STACK_FRAME("openfl.display.Loader","BitmapData_onError",0x2d70cc54,"openfl.display.Loader.BitmapData_onError","openfl/display/Loader.hx",652,0x7a569d9f)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_,"_")
		HX_STACK_LINE(654)
