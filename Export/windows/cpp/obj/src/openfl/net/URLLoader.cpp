		...
		if ((tmp3)){
			...
			Void run(Dynamic _){
				...
				HX_STACK_ARG(_,"_")
				{
					...
					HX_STACK_LINE(333)
					::lime::utils::ByteArray tmp6 = ::lime::utils::ByteArray_obj::readFile(tmp5);		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(333)
					::lime::utils::ByteArray bytes = tmp6;		HX_STACK_VAR(bytes,"bytes");
					HX_STACK_LINE(50)
					{
						HX_STACK_LINE(52)
						...
						while((true)){
							...
							HX_STACK_LINE(334)
							::lime::utils::ByteArray tmp10 = bytes;		HX_STACK_VAR(tmp10,"tmp10");
							HX_STACK_LINE(58)
							tmp9(tmp10).Cast< Void >();
							HX_STACK_LINE(60)
							...
							if ((tmp12)){
								...
								HX_STACK_LINE(62)
								worker->__Field(HX_HCSTRING("onComplete","\xf8","\xd4","\x7e","\x5d"), hx::paccDynamic )->__Field(HX_HCSTRING("remove","\x44","\x9c","\x88","\x04"), hx::paccDynamic )(tmp13);
							}
							else{
								HX_STACK_LINE(66)
								(i)++;
			...
			Void run(Dynamic bytes){
				HX_STACK_FRAME("*","_Function_2_2",0x5201af79,"*._Function_2_2","openfl/net/URLLoader.hx",337,0x11daec0d)
...
::lime::utils::ByteArray URLLoader_obj::prepareData( Dynamic data){
	HX_STACK_FRAME("openfl.net.URLLoader","prepareData",0x9b201a76,"openfl.net.URLLoader.prepareData","openfl/net/URLLoader.hx",532,0x11daec0d)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.net.URLLoader","requestUrl",0x85d5f3db,"openfl.net.URLLoader.requestUrl","openfl/net/URLLoader.hx",570,0x11daec0d)
		HX_STACK_THIS(this)
		...
		if (  ( _switch_1==HX_HCSTRING("HEAD","\x20","\xf1","\xcb","\x2f"))){
			...
			HX_STACK_LINE(595)
			{
				...
				int __ArgCount() const { return 1; }
				::String run(int a1){
					HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","openfl/net/URLLoader.hx",595,0x11daec0d)
					HX_STACK_ARG(a1,"a1")
					{
						HX_STACK_LINE(595)
			...
			HX_STACK_LINE(602)
			{
				...
				int __ArgCount() const { return 1; }
				::String run(int a1){
					HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","openfl/net/URLLoader.hx",602,0x11daec0d)
					HX_STACK_ARG(a1,"a1")
					{
						HX_STACK_LINE(602)
						int tmp11 = a1;		HX_STACK_VAR(tmp11,"tmp11");
			...
			HX_STACK_LINE(608)
			{
				...
				int __ArgCount() const { return 1; }
				::String run(int a1){
					HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","openfl/net/URLLoader.hx",608,0x11daec0d)
					HX_STACK_ARG(a1,"a1")
					{
						HX_STACK_LINE(608)
...
;
		...
		int __ArgCount() const { return 1; }
		Void run(Dynamic _){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/net/URLLoader.hx",636,0x11daec0d)
			HX_STACK_ARG(_,"_")
			{
				HX_STACK_LINE(638)
		...
		int __ArgCount() const { return 1; }
		Void run(int result){
			HX_STACK_FRAME("*","_Function_1_2",0x5200ed38,"*._Function_1_2","openfl/net/URLLoader.hx",642,0x11daec0d)
...
int URLLoader_obj::writeFunction( ::String output,int size,int nmemb){
	HX_STACK_FRAME("openfl.net.URLLoader","writeFunction",0xa65d557c,"openfl.net.URLLoader.writeFunction","openfl/net/URLLoader.hx",673,0x11daec0d)
	HX_STACK_THIS(this)
...
int URLLoader_obj::headerFunction( ::String output,int size,int nmemb){
	HX_STACK_FRAME("openfl.net.URLLoader","headerFunction",0x642c53c0,"openfl.net.URLLoader.headerFunction","openfl/net/URLLoader.hx",681,0x11daec0d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(output,"output")
	HX_STACK_ARG(size,"size")
	HX_STACK_ARG(nmemb,"nmemb")
...
int URLLoader_obj::progressFunction( Float dltotal,Float dlnow,Float uptotal,Float upnow){
	HX_STACK_FRAME("openfl.net.URLLoader","progressFunction",0x5fbe16a0,"openfl.net.URLLoader.progressFunction","openfl/net/URLLoader.hx",689,0x11daec0d)
	HX_STACK_THIS(this)
...
::String URLLoader_obj::readFunction( int max,::lime::utils::ByteArray input){
	HX_STACK_FRAME("openfl.net.URLLoader","readFunction",0x284701c9,"openfl.net.URLLoader.readFunction","openfl/net/URLLoader.hx",711,0x11daec0d)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.net.URLLoader","onData",0x971179e4,"openfl.net.URLLoader.onData","openfl/net/URLLoader.hx",728,0x11daec0d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_,"_")
		HX_STACK_LINE(741)
...
{
		HX_STACK_FRAME("openfl.net.URLLoader","onError",0x36daeace,"openfl.net.URLLoader.onError","openfl/net/URLLoader.hx",748,0x11daec0d)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.net.URLLoader","onOpen",0x9e622784,"openfl.net.URLLoader.onOpen","openfl/net/URLLoader.hx",758,0x11daec0d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(760)
...
{
		HX_STACK_FRAME("openfl.net.URLLoader","onProgress",0xe8ae8067,"openfl.net.URLLoader.onProgress","openfl/net/URLLoader.hx",767,0x11daec0d)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.net.URLLoader","onSecurityError",0x2c8cbdee,"openfl.net.URLLoader.onSecurityError","openfl/net/URLLoader.hx",778,0x11daec0d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(msg,"msg")
		HX_STACK_LINE(780)
...
{
		HX_STACK_FRAME("openfl.net.URLLoader","onStatus",0x7d45ed6c,"openfl.net.URLLoader.onStatus","openfl/net/URLLoader.hx",788,0x11daec0d)
		HX_STACK_THIS(this)
...
::openfl::net::URLLoaderDataFormat URLLoader_obj::set_dataFormat( ::openfl::net::URLLoaderDataFormat inputVal){
	HX_STACK_FRAME("openfl.net.URLLoader","set_dataFormat",0x4cc5d3b9,"openfl.net.URLLoader.set_dataFormat","openfl/net/URLLoader.hx",804,0x11daec0d)
	HX_STACK_THIS(this)
